...
function LeadCard({
  ...
  return (
    <div
      onClick={onClick}
      className="rounded-xl border border-border bg-card p-3 active:bg-card-hover transition-colors cursor-pointer"
    >
      {/* Row 1: Name + Bedrooms */}
      ...
      <p className="text-xs text-muted mt-1 truncate">
        {lead.building_name || "--"}
        {lead.unit_number ? ` · Unit ${lead.unit_number}` : ""}
      </p>

      {/* Row 3: Phone + Completeness */}
